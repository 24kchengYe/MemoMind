...
- LANGUAGE: Write each observation in the SAME language as the source facts. Chinese facts → Chinese observations. English facts → English observations. NEVER translate between languages. Keep proper nouns (product names, person names, technical terms) in their original form.
